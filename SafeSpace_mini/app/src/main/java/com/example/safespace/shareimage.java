...
public class shareimage extends AppCompatActivity {
    ...
    private void senEmail() {
        ...
        String mMessage = "The Image is shared in your account from "+ems;
        ...
        doc.addSnapshotListener(this, new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                databaseReference = FirebaseDatabase.getInstance().getReference(value.getString("uid").toString()).child("Images");
        ...
        javaMailAPI.execute();
        //Toast.makeText(this, "Send mail"+mEmail, Toast.LENGTH_SHORT).show();
        Intent i1=new Intent(this,ImagesActivity.class);
